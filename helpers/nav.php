<?php
    ...
    if ($pageName == 'grabBag') {
		...
		if ($pageName == 'reversing') {
	        echo '<li class="active ' . $disabledText . '"><a>Reversing<span class="sr-only">(current)</span></a></li>';
    } else {
    	echo '<li class=" ' . $disabledText . '"><a'; if ($href) {echo ' href="' . $pathToRoot . 'problems/reversing.php"';} echo '>Reversing</a></li>';
    }
		if ($pageName == 'flash') {
